...
//
// We don't hit a real database — the panel's two endpoints
// (GET /api/v1/admin/subscription/users and GET /…/users/{id}) are
// mocked with page.route. That keeps this test focused on the panel's
// rendering contract and independent of whatever's in the test DB.
