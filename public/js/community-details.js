...
function updateDepartmentJoinButton(departmentId, status) {
  ...
  const AUDIT_ACTION_LABELS = {
    ...
    'department.member_approved': 'Approved department member',
    'department.member_declined': 'Declined department member',
    'department.member_removed': 'Removed department member',
