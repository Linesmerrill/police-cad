  ...
  const sections = [
    {
      ...
      content: (
        <>
          ...
          <ul style={{ margin: '1.25rem 0', paddingLeft: '2rem', listStyleType: 'disc', listStylePosition: 'outside' }}>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>Posting limit:</strong> Each community may publish one promotion per fixed time window (currently once every 24 hours). This interval may be adjusted by Lines Police CAD at any time.</li>
