  ...
  const sections = [
    {
      ...
      content: (
        <>
          ...
          <h4 style={{ fontSize: '1.125rem', fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginTop: '2rem', marginBottom: '1rem', paddingBottom: '0.5rem', borderBottom: '1px solid rgba(59, 130, 246, 0.15)' }}>Community Boost &amp; Promotion</h4>
          <p style={{ margin: '1.25rem 0', textAlign: 'left', lineHeight: '1.8', color: 'rgba(255, 255, 255, 0.7)' }}>Lines Police CAD offers two separate systems for promoting your community on the platform: <strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)' }}>Community Boosts</strong> (available on the web) and <strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)' }}>Community Promotions</strong> (available on the mobile app). Both systems provide similar promotional benefits but are operated independently with different pricing, billing models, and management methods. Purchasing a boost or promotion on one platform does not affect or transfer to the other.</p>
          <h4 style={{ fontSize: '1.125rem', fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginTop: '2rem', marginBottom: '1rem', paddingBottom: '0.5rem', borderBottom: '1px solid rgba(59, 130, 246, 0.15)' }}>Web Community Boosts</h4>
          <p style={{ margin: '1.25rem 0', textAlign: 'left', lineHeight: '1.8', color: 'rgba(255, 255, 255, 0.7)' }}>Community Boosts are one-time purchases available on the web at linespolice-cad.com. They provide promotional benefits for a fixed duration of 1, 3, or 6 months. Multi-month bundles are offered at a discounted rate compared to purchasing individual months.</p>
          <p style={{ margin: '1.25rem 0', textAlign: 'left', lineHeight: '1.8', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>Tiers and Pricing:</strong></p>
          <ul style={{ margin: '1.25rem 0', paddingLeft: '2rem', listStyleType: 'disc', listStylePosition: 'outside' }}>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>Basic Tier</strong> ($3/1mo, $7/3mo, $12/6mo): Boosted placement in community search results.</li>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>Standard Tier</strong> ($5/1mo, $12/3mo, $20/6mo): Boosted in search results, promotional text in search, and a verified community badge.</li>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>Premium Tier</strong> ($8/1mo, $19/3mo, $32/6mo): Boosted in search results, promotional text in search, verified community badge, and a boost on the Discover Communities page.</li>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>Elite Tier</strong> ($15/1mo, $36/3mo, $60/6mo): All Premium features plus a featured spot on the Home Page and a promotional description (up to 200 characters).</li>
          </ul>
          <p style={{ margin: '1.25rem 0', textAlign: 'left', lineHeight: '1.8', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>Billing and Payment:</strong></p>
          <ul style={{ margin: '1.25rem 0', paddingLeft: '2rem', listStyleType: 'disc', listStylePosition: 'outside' }}>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}>Web Community Boosts are one-time payments, not recurring subscriptions. You are charged once for the selected duration and your boost expires at the end of that period.</li>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}>Payments are processed securely through Stripe. You agree to provide accurate payment information and authorize Lines Police CAD to charge the applicable boost fee.</li>
          </ul>
          <p style={{ margin: '1.25rem 0', textAlign: 'left', lineHeight: '1.8', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>Upgrades, Extensions, and Downgrades:</strong></p>
          <ul style={{ margin: '1.25rem 0', paddingLeft: '2rem', listStyleType: 'disc', listStylePosition: 'outside' }}>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>Upgrades:</strong> If you upgrade to a higher tier while an active boost is in effect, the unused portion of your current boost will be prorated and credited toward the new purchase price. The credit is calculated based on the remaining days of your current boost relative to its total duration.</li>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>Extensions:</strong> If you purchase the same tier again while an active boost is in effect, the new duration will be added to your existing expiration date.</li>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>Downgrades:</strong> You cannot downgrade to a lower tier while an active boost is in effect. You must wait for the current boost to expire before purchasing a lower tier.</li>
          </ul>
          <h4 style={{ fontSize: '1.125rem', fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginTop: '2rem', marginBottom: '1rem', paddingBottom: '0.5rem', borderBottom: '1px solid rgba(59, 130, 246, 0.15)' }}>Mobile App Community Promotions</h4>
          <p style={{ margin: '1.25rem 0', textAlign: 'left', lineHeight: '1.8', color: 'rgba(255, 255, 255, 0.7)' }}>Community Promotions are recurring subscriptions available through the Lines Police CAD mobile app (iOS and Android). They provide similar promotional benefits to Web Community Boosts but are billed as monthly auto-renewing subscriptions at different price points.</p>
          <p style={{ margin: '1.25rem 0', textAlign: 'left', lineHeight: '1.8', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>Tiers and Pricing:</strong></p>
          <ul style={{ margin: '1.25rem 0', paddingLeft: '2rem', listStyleType: 'disc', listStylePosition: 'outside' }}>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>Basic Tier</strong> ($4.99/month)</li>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>Standard Tier</strong> ($9.99/month)</li>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>Premium Tier</strong> ($19.99/month)</li>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>Elite Tier</strong> ($49.99/month)</li>
          </ul>
          <p style={{ margin: '1.25rem 0', textAlign: 'left', lineHeight: '1.8', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>Billing and Payment:</strong></p>
          <ul style={{ margin: '1.25rem 0', paddingLeft: '2rem', listStyleType: 'disc', listStylePosition: 'outside' }}>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}>Mobile App Community Promotions are recurring monthly subscriptions billed through the Apple App Store or Google Play Store.</li>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}>Subscriptions auto-renew at the end of each billing period unless cancelled at least 24 hours prior to the next renewal.</li>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}>You are responsible for managing your subscription directly through your device's app store subscription settings.</li>
          </ul>
          <p style={{ margin: '1.25rem 0', textAlign: 'left', lineHeight: '1.8', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>Why the Pricing Differs:</strong></p>
          <p style={{ margin: '1.25rem 0', textAlign: 'left', lineHeight: '1.8', color: 'rgba(255, 255, 255, 0.7)' }}>Web Community Boosts and Mobile App Community Promotions are two independent systems. The mobile app pricing is higher due to platform fees charged by Apple and Google on in-app purchases. Web Boosts are processed directly through Stripe, which allows us to offer lower prices and multi-month bundle discounts. Both systems provide the same promotional benefits for your community.</p>
          <p style={{ margin: '1.25rem 0', textAlign: 'left', lineHeight: '1.8', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>User Obligations (Both Systems):</strong></p>
          <ul style={{ margin: '1.25rem 0', paddingLeft: '2rem', listStyleType: 'disc', listStylePosition: 'outside' }}>
            ...
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}>Lines Police CAD reserves the right to suspend or terminate your community boost or promotion if we detect misuse or violation of these terms.</li>
          </ul>
          ...
          <h4 style={{ fontSize: '1.125rem', fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginTop: '2rem', marginBottom: '1rem', paddingBottom: '0.5rem', borderBottom: '1px solid rgba(59, 130, 246, 0.15)' }}>Discord Community Promotion</h4>
          <p style={{ margin: '1.25rem 0', textAlign: 'left', lineHeight: '1.8', color: 'rgba(255, 255, 255, 0.7)' }}>Community owners and administrators may submit a structured recruitment listing from their community page to be posted, on their behalf, to the official Lines Police CAD Discord server. This feature is available to all communities; a community&apos;s boost tier (described above) affects only the styling and size of the post &mdash; for example a longer description, banner image, image gallery, or verified and featured markers. Boosting is optional and is not required to post a basic listing.</p>
          <p style={{ margin: '1.25rem 0', textAlign: 'left', lineHeight: '1.8', color: 'rgba(255, 255, 255, 0.7)' }}>By using the Discord Community Promotion feature, you agree to the following:</p>
          <ul style={{ margin: '1.25rem 0', paddingLeft: '2rem', listStyleType: 'disc', listStylePosition: 'outside' }}>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>Posting limit:</strong> Each community may publish one promotion per fixed time window (currently once every 24 hours). This interval may be adjusted by Lines Police CAD at any time. Creating additional communities, or using multiple accounts, to post the same or similar promotion more frequently than this limit allows is considered an attempt to evade the posting limit and is prohibited.</li>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>Your content, your responsibility:</strong> The community owner and administrators are solely responsible for all content submitted through this feature, including text, images, and invite links. You must own or have the right to use any images you upload.</li>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>Content standards:</strong> Promotion content must be accurate and must not be offensive, misleading, illegal, infringing, or otherwise in violation of our content guidelines. It must also comply with Discord&apos;s Terms of Service and Community Guidelines.</li>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>Public publication:</strong> Submitting a promotion publishes it to a public channel where it is visible to all members of that Discord server. Lines Police CAD does not control how third parties may view, copy, or share content once it has been posted.</li>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>Our discretion:</strong> Lines Police CAD may refuse, modify, or remove any promotion at its discretion, and may revoke a community&apos;s access to this feature for spam, attempts to evade the posting limit, prohibited content, or any other violation of these terms.</li>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>Enforcement and appeals:</strong> Where a user violates these promotion terms, Lines Police CAD may restrict that user&rsquo;s ability to post promotions from any community they own. Restrictions escalate with repeat violations &mdash; typically a 7-day restriction for a first offense, 30 days for a second, one year for a third, and a permanent restriction for further offenses. We will ordinarily notify the affected user by email with the reason and supporting details. If you believe a restriction was applied in error, you may appeal by opening a ticket in the assistance channel of the official Lines Police CAD Discord server.</li>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>No guarantee of results:</strong> Lines Police CAD does not guarantee any particular reach, visibility, member growth, or other outcome from posting a promotion.</li>
          </ul>
          ...
          <p style={{ margin: '1.25rem 0', textAlign: 'left', lineHeight: '1.8', color: 'rgba(255, 255, 255, 0.7)' }}>Program participants receive the following benefits:</p>
          <ul style={{ margin: '1.25rem 0', paddingLeft: '2rem', listStyleType: 'disc', listStylePosition: 'outside' }}>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}>A free Base Plan subscription for your Lines Police CAD account (the account used to apply)</li>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}>A free Base Plan subscription for one community you own</li>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}>A public profile on the Content Creators page</li>
            <li style={{ margin: '0.5rem 0', lineHeight: '1.8', display: 'list-item', color: 'rgba(255, 255, 255, 0.7)' }}>Recognition within the Lines Police CAD community</li>
          </ul>
          <p style={{ margin: '1.25rem 0', textAlign: 'left', lineHeight: '1.8', color: 'rgba(255, 255, 255, 0.7)' }}>Benefits are subject to change at any time at the sole discretion of Lines Police CAD.</p>
          <h4 style={{ fontSize: '1.125rem', fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginTop: '2rem', marginBottom: '1rem', paddingBottom: '0.5rem', borderBottom: '1px solid rgba(59, 130, 246, 0.15)' }}>Existing Subscriptions</h4>
          <p style={{ margin: '1.25rem 0', textAlign: 'left', lineHeight: '1.8', color: 'rgba(255, 255, 255, 0.7)' }}>If you or your community already have a higher-tier subscription (e.g., Premium or Premium+) when joining the Program, we will not downgrade your subscription to the Base Plan. You will keep your existing subscription as long as you continue paying for it.</p>
          <p style={{ margin: '1.25rem 0', textAlign: 'left', lineHeight: '1.8', color: 'rgba(255, 255, 255, 0.7)' }}><strong style={{ fontWeight: '600', color: 'rgba(255, 255, 255, 0.9)', marginRight: '0.25rem' }}>Example:</strong> If you have a Premium+ subscription and become a content creator, you will keep your Premium+ subscription as long as you continue paying. If you cancel your Premium+ subscription and it expires, you will then be placed on the free Base Plan as part of the Program benefits.</p>
          <p style={{ margin: '1.25rem 0', textAlign: 'left', lineHeight: '1.8', color: 'rgba(255, 255, 255, 0.7)' }}>The same applies to community subscriptions. If your community has a higher-tier subscription, it will not be downgraded when you apply the Program promotion.</p>
          ...
          <p style={{ margin: '1.25rem 0', textAlign: 'left', lineHeight: '1.8', color: 'rgba(255, 255, 255, 0.7)' }}>Content creators may apply a free Base Plan subscription to one community they own. This promotion cannot be transferred to another community once applied.</p>
          ...
          <p style={{ margin: '1.25rem 0', textAlign: 'left', lineHeight: '1.8', color: 'rgba(255, 255, 255, 0.7)' }}>Upon removal, all Program benefits will be immediately revoked. If your account or community subscription was provided as part of the Program (Base Plan), it will be reverted to the Free tier. If you have a higher-tier paid subscription that you were paying for independently, that subscription will remain active.</p>
          ...
          <p style={{ margin: '1.25rem 0', textAlign: 'left', lineHeight: '1.8', color: 'rgba(255, 255, 255, 0.7)' }}>You may withdraw from the Program at any time by submitting a withdrawal request through your creator dashboard.</p>
          <p style={{ margin: '1.25rem 0', textAlign: 'left', lineHeight: '1.8', color: 'rgba(255, 255, 255, 0.7)' }}>Upon withdrawal, all Program benefits will be immediately revoked. If your account or community subscription was provided as part of the Program (Base Plan), it will be reverted to the Free tier. If you have a higher-tier paid subscription that you were paying for independently, that subscription will remain active.</p>
