        ...
        setTiers([
          {
            ...
            key: 'basic',
            monthlyPrice: 3,
            features: ['Boosted in search results', 'Discord community promotion'],
            color: '#3b82f6',
          },
          {
            name: 'Standard',
            key: 'standard',
            monthlyPrice: 5,
            features: ['Boosted in search results', 'Discord promotion with image gallery', 'Promotional text in search', 'Verified community badge'],
            color: '#10b981',
          },
          {
            name: 'Premium',
            key: 'premium',
            monthlyPrice: 8,
            features: ['Boosted in search results', 'Discord promotion with banner image', 'Promotional text in search', 'Verified community badge', 'Boost on Discover page'],
            color: '#667eea',
          },
          {
            name: 'Elite',
            key: 'elite',
            monthlyPrice: 15,
            features: ['Boosted in search results', 'Featured Discord promotion', 'Promotional text in search', 'Verified community badge', 'Boost on Discover page', 'Featured on Home Page', 'Promotional description (200 chars)'],
            color: '#fbbf24',
            popular: true,
          },
        ]);
